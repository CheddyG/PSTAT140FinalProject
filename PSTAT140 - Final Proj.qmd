---
title: "DMAIC and SPC Analysis of Ford F-150 Safety Complaints and Recalls, 2015–2025"
...
get_complaints <- function(year) {
  
  url <- paste0(
    "https://api.nhtsa.gov/complaints/complaintsByVehicle?",
    "make=Ford&model=F-150&modelYear=", year
  )
  ...
  response$results |>
    mutate(model_year_searched = year)
}

f150_complaints <- map_dfr(years, get_complaints)

glimpse(f150_complaints)
```
